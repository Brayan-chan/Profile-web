...
export const homePageContent: HomePageContent = {
  seo: {
    title: "Brayan Chan",
    description:
      "Full time student from Campeche, Camp, México who loves building cool things using code.",
    image: identity.logo,
  },
  role: "Student & Software Developer",
  description:
    "I'm Brayan Chan, a full time student from Campeche, Camp, México who also loves building cool things using code.",
    ...
    items: [
      {
        ...
        company: {
          name: "Freelance",
          image: "/logo.webp",
          url: "https://github.com/Brayan-chan",
        },
        date: "2021 - Present",
      },
      {
